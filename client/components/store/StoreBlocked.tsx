    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[var(--color-background)]">
        <div className="text-center max-w-md">
          <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 bg-amber-500/10 text-amber-500">
          ...
          <p className="text-[var(--color-text-secondary)] mb-2">
            Estamos realizando mejoras para darte una mejor experiencia.
          </p>
