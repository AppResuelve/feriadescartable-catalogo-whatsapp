...
function InfoCard({
  ...
  const base = `
    ...
    hover:shadow-[0_4px_20px_rgba(79,200,28,0.08)]
            ...
            <div>
              <div className="mb-8">
                ...
                <div className="flex items-center gap-2 mt-3">
                  ...
                  <div className="w-1 h-1 rounded-full" style={{ backgroundColor: "var(--color-primary)", opacity: 0.7 }} />
          ...
          <section className="bg-[#1a1a1a] relative overflow-hidden px-4 sm:px-6 lg:px-8 py-14">
            ...
            <div className="max-w-xl mx-auto text-center relative">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div className="h-px w-8" style={{ backgroundColor: "var(--color-primary)", opacity: 0.4 }} />
                <span className="text-xs font-medium tracking-[0.2em] uppercase" style={{ color: "var(--color-primary)", opacity: 0.8 }}>
                  Respuesta rápida
                </span>
                <div className="h-px w-8" style={{ backgroundColor: "var(--color-primary)", opacity: 0.4 }} />
              </div>
