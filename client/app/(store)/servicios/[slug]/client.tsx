  ...
  return (
    <>
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8" style={{ backgroundColor: "var(--color-background)", paddingTop: "5rem", paddingBottom: "3rem" }}>
        <PetalDeco className="absolute top-6 right-[7%] text-[var(--color-primary)] hidden md:block" style={{ width: 100, opacity: 0.08 }} />
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "var(--color-primary)", opacity: 0.7 }} />
